    ...
    <body id="page-top" class="index">
        ...
        <header>
            <div class="container">
                <div class="intro-text">
                    ...
                    <a href="http://imsglobal.org/lti/#lti2.0" target="_blank" class="page-scroll btn btn-xl">What is LTI 2.0 ?</a>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                ...
                <div class="col-lg-12 text-center">
                    <div class="bs-example">
                                        ...
                                        <a href="#error" class="btn btn-lg btn-primary" data-toggle="modal">Register</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h3 align="center"  >Please sign in to register your tool.<br></h3>
                                                        <div align="left">
                                        ...
                                        <div id="<%=i%>" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h3 align="center"  >Required Custom Parameters<br></h3>
                                        ...
                                        <div id="<%=i + "1"%>" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h3 align="center">Optional Custom Parameters</h3>
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4" >
                        <div class="team-member">
                            ...
                            <ul class="list-inline social-buttons">
                                ...
                                <li><a href="https://www.linkedin.com/profile/view?id=229970388&trk=hp-identity-name" target="_blank"><i class="fa fa-linkedin"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="team-member">
                            ...
                            <ul class="list-inline social-buttons">
                                <li><a href="https://twitter.com/mukulgpt20" target="_blank"><i class="fa fa-twitter"></i></a>
                                </li>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="team-member">
                            <img src="Design/images/vishal.jpg" class="img-responsive img-circle" alt="">
                            <h4>Vishal Sharma</h4>
                            <p class="text-muted">Intern</p>
                            <p class="section-subheading text-muted">(Computer Science And Engineering)<br>MNIT Jaipur</p>
                            <ul class="list-inline social-buttons">
                    ...
                    <div class="col-sm-6 col-md-6 ">
                        <div class="team-member">
                            <img src="Design/images/Avinash.jpg" class="img-responsive img-circle" alt="">
                            <h4>Avinash Awate</h4>
                            <p class="text-muted">Chief Mentor</p>
        ...
        <footer class="bg-darkest-gray">
            ...
            <div class="container" >
                <div  >
                    <div class="col-md-12">
                        <span style="color:white" class="copyright">Copyright &copy; utp.ekshiksha.org.in</span>
                        <span  style="color:white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Summer Internship IITB 2015</span>
                    </div>
